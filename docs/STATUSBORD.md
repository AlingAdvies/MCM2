...
**Gegenereerd:** 2026-08-31 13:53 UTC · **Bron:** `gh issue list --repo AlingAdvies/MCM2`
...
- [#198](https://github.com/AlingAdvies/MCM2/issues/198) `before-pilot` — Admin-only contract-import (CSV) met vendor/contact find-or-create
